...
squads = [
	[blufor_squad_inf_light,150,10,0],
	[blufor_squad_inf,200,20,0],
	[blufor_squad_at,150,50,0],
	[blufor_squad_aa,100,20,0],
	[blufor_squad_recon,200,10,0],
	[blufor_squad_para,150,10,0]
];
