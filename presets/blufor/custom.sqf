...
light_vehicles = [
	["R71USA",											20,		0,		5],
	["fow_v_universalCarrier",							40,		5,		10],
	["LIB_US_NAC_Willys_MB",							30,		0,		10],
	["lib_us6_open",									40,		0,		15],
	["LIB_US_NAC_GMC_Open",								40,		0,		15],
	["LIB_US_NAC_GMC_Tent",								40,		0,		15],
	["LIB_US_Scout_M3",									65,		10,		20],
  //["LIB_US_M3_Halftrack",								75,		10,		30],
	["LIB_US_NAC_M3_Halftrack",							75,		10,		25],
	["fow_v_lvta2_usa",									150,	100,	25],
	["LIB_Zis5v_61k",									150,	100,	30],
	["LIB_M8_Greyhound",								150,	150,	50],
	["LIB_US6_BM13",									1500,	1000,	30]
];
...
heavy_vehicles = [
	...
	["LIB_M4A3_76",										600,	300,	200],
	["LIB_M4A3_76_HVSS",								700,	300,	250],
	["LIB_M4A4_Firefly",								800,	400,	300]
];
...
air_vehicles = [
	...
	["sab_d510",										40,		10,		25],
	["lib_p26",											50,		10,		25],
	["lib_C47_Skytrain",								75,		0,		75],
	["LIB_US_P39",										150,	100,	100],
	["LIB_US_P39_2",									175,	150,	100],
	["ifa3_p47",										240,	200,	150],
	["ifa3_p47_rocket",									260,	250,	150],
	["lib_p51_mustang_blue_1",							300,	300,	200],
	["sab_mb5",											325,	350,	250],
	["sab_texan",										375,	375,	300],
	...
	["lib_b17_beige",									950,	950,	800],
	["lib_b24_green_2",									1100,	1250,	850],
	["lib_b25_green",									1200,	1200,	650]
];

static_vehicles = [
    ["fow_w_vickers_uk",								15,		10,		0],
	["LIB_M2_60",										50,		25,		0],
	["ifa3_M2StaticMG_base",							25,		10,		0],
	["fow_uk_6Pounder",									100,	50,		0],
	["fow_w_6pounder_usa",								100,	50,		0],
	["LIB_leFH18",										250,	75,		0],
	["LIB_Nebelwerfer41",								300,	150,	0],
	["sab_small_static_aa2",							150,	75,		0],
	["sab_small_static_2xaa2",							175,	150,	0],
	["sab_static_aa2",									250,	175,	0],
	["sab_static_deckgun2",								200,	250,	0],
	["sab_static_12inch2",								500,	500,	0],
	["sab_item_flak0",									10,		5,		0]
];
...
support_vehicles = [
	...
	[Respawn_truck_typename,							150,	0,		100],
	[FOB_truck_typename,								250,	200,	100],
	[KP_liberation_small_storage_building,				0,		0,		0],
	[KP_liberation_large_storage_building,				0,		0,		0],
	[KP_liberation_recycle_building,					200,	0,		0],
	[KP_liberation_plane_slot_building,					150,	0,		0],
	[KP_liberation_air_vehicle_building,				300,	150,	0],
