class liberation_production {
	...
	controls[] = {
		...
		"SectorName", "SectorTypeLabel", "SectorType", "SectorStorageLabel", "SectorStorage", "SectorTimerLabel", "SectorTimer",
		...
		"ProduceTitle", "ProduceCheckBoxes", "ButtonSaveSector",
