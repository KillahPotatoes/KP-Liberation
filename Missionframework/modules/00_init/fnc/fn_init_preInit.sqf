/*
    ...
    Description:
        preInit function of this module.
        Sets/Reads module settings, inizializes module globals and adds module specific event handlers.
...
/*
    ----- Module Globals -----
    TODO: Currently moved some variables from the KPLIB_config here until we find a better place.
*/
