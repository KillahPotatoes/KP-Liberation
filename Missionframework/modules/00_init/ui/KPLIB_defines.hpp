...
#define KPLIB_GUI_TEXT_SIZE_XLARGE      (GUI_GRID_H * 1.4)

// Colors
#define KPLIB_GUI_COLOR_BACKGROUND      {0, 0, 0, 0.5}
...
#define KPLIB_GUI_POS_Y                 safeZoneY + safeZoneH * 0.2
#define KPLIB_GUI_WIDTH                 safeZoneW * 0.5
#define KPLIB_GUI_POS_X_CROSS           safeZoneX + safeZoneW * 0.73
#define KPLIB_GUI_POS_Y_CROSS           safeZoneY + safeZoneH * 0.205
#define KPLIB_GUI_POS_X_AREA            safeZoneX + safeZoneW * 0.25
...
#define KPLIB_GUI_POS_Y_LARGE           safeZoneY + safeZoneH * 0.15
#define KPLIB_GUI_WIDTH_LARGE           safeZoneW * 0.7
#define KPLIB_GUI_POS_X_CROSS_LARGE     safeZoneX + safeZoneW * 0.83
#define KPLIB_GUI_POS_Y_CROSS_LARGE     safeZoneY + safeZoneH * 0.155
#define KPLIB_GUI_POS_X_AREA_LARGE      safeZoneX + safeZoneW * 0.15
...
#define KPLIB_GUI_POS_Y_CORNER          safeZoneY + safeZoneH * 0.05
#define KPLIB_GUI_WIDTH_CORNER          safeZoneW * 0.25
#define KPLIB_GUI_POS_X_CROSS_CORNER    safeZoneX + safeZoneW * 0.265
#define KPLIB_GUI_POS_Y_CROSS_CORNER    safeZoneY + safeZoneH * 0.055
#define KPLIB_GUI_POS_X_AREA_CORNER     safeZoneX + safeZoneW * 0.035
