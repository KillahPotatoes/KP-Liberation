/*
    KPLIB_fnc_garrison_delLightVeh

    File: fn_garrison_delLightVeh.sqf
    ...
    Description:
        Removes one occurance of given vehicle classname from the light vehicle garrison of given sector.
...
(_garrisonRef select 3) deleteAt (_garrisonRef findIf {_x isEqualTo _class});
