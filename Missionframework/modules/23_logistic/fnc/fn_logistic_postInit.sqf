...
if (isServer) then {
    ...
    } forEach ["vehLightUnarmed", "vehLightArmed", "vehTrans", "boats", "vehHeavyApc", "vehHeavy", "vehAntiAir", "vehArty", "heliTrans", "heliAttack", "planeTrans", "jets", "logistic"];
    KPLIB_logistic_data setVariable ["Vehicles", _vehicles]
};
