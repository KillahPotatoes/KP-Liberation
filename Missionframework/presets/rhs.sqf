...
// Both RHS USAF and RHS AFRF mods are required. 
...
KP_liberation_little_bird_classname = "RHS_MELB_MH6M"; 					// These are the little birds that spawn on the lhd or at Chimera base. 																Default is "B_Heli_Light_01_F".
