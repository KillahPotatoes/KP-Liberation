...
FOB_truck_typename = "d3s_scania_16_device";                           // This is the FOB as a vehicle.
...
infantry_units = [
    ...
    ["BWA3_AutoriflemanMG5_Fleck", 60,200,0],                           // Heavygunner
    ["BWA3_RiflemanAT_Pzf3_Fleck", 60,100,0],                           // Rifleman (AT)
    ["BWA3_Crew_Fleck", 60,5,0],                                        // Crewman
    ["BWA3_Helipilot", 60,5,0],                                         // Helicopter Pilot
    ["BWA3_CombatLifeSaver_Fleck", 70,5,0],                             // Combat Life Saver
    ["BWA3_Engineer_Fleck", 70,10,10],                                  // Engineer
    ["BWA3_recon_LAT_Fleck", 70,100,0],                                 // Recon Rifleman (AT)
    ["BWA3_recon_Marksman_Fleck", 70,50,0],                             // Recon Marksman
    ["BWA3_recon_Medic_Fleck", 70,5,0],                                 // Recon Combat Life Saver
    ["BWA3_recon_Pioneer_Fleck", 75,100,100],                           // Recon Engineer
    ["BWA3_recon_Fleck", 80,20,0],                                      // Recon Rifleman
    ["BWA3_RiflemanAT_RGW90_Fleck", 80,100,0],                          // AT Specialist
    ["BWA3_RiflemanAA_Fliegerfaust_Fleck", 90,200,0],                   // AA Specialist
    ["BWA3_Marksman_Fleck", 95,100,0],                                  // Marksman
    ["BWA3_Sniper_G82_Fleck", 100,400,0],                               // Sniper (G82)
    ["CUP_B_GER_Fleck_Operator", 100,30,0],                             // KSK Assault Rifleman
    ["CUP_B_GER_Fleck_Operator_GL", 100,50,0],                          // KSK Assault Grenadier
    ["CUP_B_GER_Fleck_Soldier_Ammo", 100,100,0],                        // KSK Ammo Bearer
    ["CUP_B_GER_Fleck_Soldier_MG3", 110,200,0],                         // KSK Machinegunner (MG3)
    ["CUP_B_GER_Fleck_Soldier_AT", 110,100,0],                          // KSK AT Specialist (Carl Gustav)
    ["CUP_B_GER_Fleck_Soldier_AA", 115,200,0],                          // KSK AA Specialist (Fliegerfaust)
    ["CUP_B_GER_Fleck_Medic", 120,50,0],                                // KSK Paramedic
    ["CUP_B_GER_Fleck_Soldier_Engineer", 125,10,10],                    // KSK Combat Engineer
    ["CUP_B_GER_Fleck_Soldier_Scout", 125,15,0],                        // KSK Scout
    ["CUP_B_GER_Fleck_Operator_TL", 130,20,0],                          // KSK Assault Team Leader
    ["CUP_B_GER_Fleck_Soldier_TL", 130,10,0],                           // KSK Team Leader
    ["CUP_B_GER_Fleck_Soldier_Sniper", 150,300,0]                       // KSK Sniper (G22)
...
light_vehicles = [
    ...
    ["CUP_O_BTR90_RU", 200,750,100],                                    // BTR-90
    ["CUP_B_M1128_MGS_Woodland", 200,750,100],                          // M1128 MGS (Woodland)
    ["CUP_B_M1129_MC_MK19_Woodland", 200,750,100],                      // M1129 MC MK19 CROWS (Woodland)
    ["CUP_B_M1135_ATGMV_Woodland", 200,750,100],                        // M1135 ATGMV (Woodland)
    ["CUP_O_BM21_CHDKZ", 200,1000,75],                                  // BM-21 "Grad"
    ["I_Truck_02_MRL_F", 200,1000,75]                                   // ZAMAK MRL
];

heavy_vehicles = [
    ["BWA3_Puma_Fleck", 350,550,275],                                   // IFV Puma
    ["CUP_B_M2A3Bradley_USA_W", 350, 550, 275],                         // M2A3 ERA Bradley IFV (Woodland)
    ["CUP_B_M7Bradley_USA_W", 350,550,275],                             // M7 Bradley
    ["CUP_B_M60A3_TTS_USMC", 400,550,200],                              // M60A3 TTS
    ["CUP_O_T72_CHDKZ", 500,500,300],                                   // T-72
    ["CUP_O_T90_RU", 500,500,300],                                      // T-90A
    ...
    ["B_T_MBT_01_arty_F", 600,600,200],                                 // M4 Scorcher
    ["CUP_O_ZUBR_RU", 1000,0,1000],                                     // Zubr-Class LCAC
    ["CUP_B_Frigate_ANZAC", 10000, 5000, 10000]                         // ANZAC Class Frigate
];

air_vehicles = [
    ["CUP_B_AH6X_USA", 100,0,100],                                      // AH-6X Littlebird ULB
    ["EC635_Unarmed_BW", 50,0,100],                                     // EC635 (Unarmed)
    ["EC635_AT_BW", 100,100,100],                                       // EC635 (AT)
    ["EC635_BW", 100,100,100],                                          // EC635
    ["B_T_UAV_03_dynamicLoadout_F", 200,100,100],                       // MQ-12 Falcon
    ...
    ["B_UAV_02_dynamicLoadout_F", 650,200,50],                          // MQ-4A GreyHawk
    ["CUP_B_USMC_DYN_MQ9", 650,200,100],                                // MQ-9 Reaper
    ["I_UAV_02_dynamicLoadout_F", 650,200,100],                         // K40 Ababil-3
    ["O_T_UAV_04_CAS_F", 650,200,100],                                  // KH-3A Fenghuang
    ...
    ["CUP_O_Ka52_RU", 750,750,100],                                     // Ka-52
    ["EAWS_EF2000_GER_CAP", 1000,1000,1000],                            // Eurofighter Typhoon (GER)
    ["FIR_A10U", 1000,1000,1000],                                       // A-10U
    ["FIR_AV8B", 1000,1000,1000],                                       // AV-8B Harrier II plus
    ["FIR_AV8B_GR9A", 1000,1000,1000],                                  // Harrier II GR9A
    ["FLAN_EA18G", 1000,1000,1000],                                     // EA-18G Growler
    ["FIR_F14D", 1000,1000,1000],                                       // F-14D Tomcat
    ["FIR_F15E", 1000,1000,1000],                                       // F-15E Strike Eagle
    ["FIR_F15K", 1000,1000,1000],                                       // F-15K Slam Eagle(2nd FX)
    ["FIR_F15SE", 1000,1000,1000],                                      // F-15SE Silent Eagle
    ["FIR_F16D", 1000,1000,1000],                                       // F-16D Fighting Falcon
    ["FIR_F22", 1000,1000,1000],                                        // F-22 Raptor
    ["FIR_F23A", 1000,1000,1000],                                       // F-23A Grey Ghost
    ["FIR_F2B", 1000,1000,1000],                                        // F-2B Viper ZERO
    ["FIR_F35B_Standard", 1000,1000,1000],                              // F-35B Lightning II
    ["FIR_F18D", 1000,1000,1000],                                       // F/A-18D Hornet
    ["FIR_FA18F", 1000,1000,1000]                                       // F/A-18F Super Hornet
...
buildings = [
    ...
    ["Flag_UK_F", 0,0,0],
    ["Flag_White_F", 0,0,0],
    ["Land_Research_house_V1_F", 0,0,0],                                 // Research House
    ["Land_Research_HQ_F", 0,0,0],                                       // Research HQ
    ...
    ["Land_Ind_IlluminantTower", 0,0,0],                                 // Illuminant Tower
    ...
    ["Land_DragonsTeeth_01_4x2_new_redwhite_F", 0,0,0],                  // Dragons Teeth (Row, Red-White, new)
    ["Land_CzechHedgehog_01_new_F", 0,0,0],                              // Czech Hedgehog (New)
    ["Land_TyreBarrier_01_line_x4_F", 0,0,0],                            // Tire Barrier (4)
    ["BlockConcrete_F", 0,0,0],
    ["Land_ConcretePanels_02_Single_v2_F", 0,0,0],
    ["Base_WarfareBBarrier10xTall", 0,0,0],                              // Wall (Long Tall)
    ["Base_WarfareBBarrier10x", 0,0,0],                                  // Wall (Long)
    ["Land_BagFenceLong", 0,0,0],
    ["Land_BagFenceCorner", 0,0,0],
    ...
    ["Land_Bunker_F", 0,0,0],                                           // Bunker
    ["Land_Pier_F", 0,0,0],                                             // Pier
    ["Bunker_PMC", 0,0,0],
    ["Fortress1", 0,0,0],
    ["Fortress2", 0,0,0],
    ["Land_HLaska", 0,0,0],                                             // Watchtower (Metal, No Roof)
    ["Land_Strazni_vez", 0,0,0],                                        // Strazni Vez (Watchtower)
    ["Land_Gate_Signs_2", 0,0,0],
    ...
    ["Land_PowerGenerator_F", 0,0,0],                                    // Power Generator
    ...
    ["rmair_SidewalkHighCurb", 0,0,0],                                  // Sidewalk (High, Curb)
    ["rmair_SidewalkHighEntryLeft", 0,0,0],                             // Sidewalk (High, Entry, Left)
    ["rmair_SidewalkHighEntryRight", 0,0,0],                            // Sidewalk (High, Entry, Right)
    ["rmair_SidewalkHighParkingLeft", 0,0,0],                           // Sidewalk (High, Lower, Parking, Left)
    ["rmair_SidewalkHighLowerLeft", 0,0,0],                             // Sidewalk (High, Lower, Left)
    ["rmair_SidewalkHighParkingMiddle", 0,0,0],                         // Sidewalk (High, Lower, Middle)
    ["rmair_SidewalkHighLowerRight", 0,0,0],                            // Sidewalk (High, Lower, Right)
    ["rmair_SidewalkHighParkingRight", 0,0,0],                          // Sidewalk (High, Parking, Right)
    ["rmair_SidewalkHighMiddleA", 0,0,0],                               // Sidewalk (High, Middle A)
    ["rmair_SidewalkHighMiddleB", 0,0,0],                               // Sidewalk (High, Middle B)
    ["rmair_SidewalkHighMiddleLow", 0,0,0],                             // Sidewalk (High, Middle, Low)
    ["rmair_SidewalkLowCurb", 0,0,0],                                   // Sidewalk (Low, Curb)
    ["rmair_SidewalkLowCurbCorner", 0,0,0],                             // Sidewalk (Low, Curb, Corner)
    ["rmair_SidewalkHighCurbCorner", 0,0,0],                            // Sidewalk (High, Curb, Corner)
    ["rmair_SidewalkLowCurbCorner", 0,0,0],                             // Sidewalk (Low, Curb, Corner)
    ["plp_ctm_WarehouseShelvesGrey", 0,0,0],                            // Warehouse Shelves (Grey)
    ["Target_PopUp_Moving_90deg_Acc2_F", 0,0,0]                         // Moving Target 1 (Front - Accuracy)
];
