...
FOB_box_typename = "gm_ge_army_shelteraceI_command_win";					// This is the FOB as a container. 																										Default is "B_Slingload_01_Cargo_F".
FOB_truck_typename = "gm_ge_army_bpz2a0_win";							// This is the FOB as a vehicle.																										Default is "B_Truck_01_box_F".
Arsenal_typename = "B_supplyCrate_F";									// This is the virtual arsenal as portable supply crates.																				Default is "B_supplyCrate_F".
Respawn_truck_typename = "gm_ge_army_u1300l_medic_win_rc";				// This is the mobile respawn (and medical) truck. 																						Default is "B_Truck_01_medical_F".
huron_typename = "gm_ge_army_m113a1g_command_win";						// This is Spartan 01, a multipurpose mobile respawn as a command M113.																	Default is "B_Heli_Transport_03_unarmed_F".
crewman_classname = "gm_ge_army_crew_mp2a1_80_win";						// This defines the crew for vehicles. 																									Default is "B_crew_F".
pilot_classname = "gm_ge_army_crew_mp2a1_80_win";						// This defines the pilot for helicopters. 																								Default is "B_Helipilot_F".
KP_liberation_little_bird_classname = "gm_ge_army_u1300l_container_win";// Little birds replaced with unimog for container transportation.																		Default is "B_Heli_Light_01_F".
