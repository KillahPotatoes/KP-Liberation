...
switch (KPLIB_presetPlayer) do {
    case  1: {[] call compileScript ["presets\players\apex.sqf", true];};
    case  2: {[] call compileScript ["presets\players\baf_mtp.sqf", true];};
    case  3: {[] call compileScript ["presets\players\baf_des.sqf", true];};
    case  4: {[] call compileScript ["presets\players\bwmod.sqf", true];};
    case  5: {[] call compileScript ["presets\players\bwmod_des.sqf", true];};
    case  6: {[] call compileScript ["presets\players\rhs_usaf_wdl.sqf", true];};
    case  7: {[] call compileScript ["presets\players\rhs_usaf_des.sqf", true];};
    case  8: {[] call compileScript ["presets\players\rhs_afrf.sqf", true];};
    case  9: {[] call compileScript ["presets\players\gm_west.sqf", true];};
    case 10: {[] call compileScript ["presets\players\gm_west_win.sqf", true];};
    case 11: {[] call compileScript ["presets\players\gm_east.sqf", true];};
    case 12: {[] call compileScript ["presets\players\gm_east_win.sqf", true];};
    case 13: {[] call compileScript ["presets\players\csat.sqf", true];};
    case 14: {[] call compileScript ["presets\players\csat_apex.sqf", true];};
    case 15: {[] call compileScript ["presets\players\unsung.sqf", true];};
    case 16: {[] call compileScript ["presets\players\cup_baf_desert.sqf", true];};
    case 17: {[] call compileScript ["presets\players\cup_baf_woodland.sqf", true];};
    case 18: {[] call compileScript ["presets\players\cup_usmc_desert.sqf", true];};
    case 19: {[] call compileScript ["presets\players\cup_usmc_woodland.sqf", true];};
    case 20: {[] call compileScript ["presets\players\cup_usa_desert.sqf", true];};
    case 21: {[] call compileScript ["presets\players\cup_usa_woodland.sqf", true];};
    case 22: {[] call compileScript ["presets\players\cup_cdf.sqf", true];};
    case 23: {[] call compileScript ["presets\players\cup_acr_desert.sqf", true];};
    case 24: {[] call compileScript ["presets\players\cup_acr_woodland.sqf", true];};
    case 25: {[] call compileScript ["presets\players\cup_chdkz.sqf", true];};
    case 26: {[] call compileScript ["presets\players\cup_sla.sqf", true];};
    case 27: {[] call compileScript ["presets\players\cup_takistan.sqf", true];};
    case 28: {[] call compileScript ["presets\players\sfp_wdl.sqf", true];};
    case 29: {[] call compileScript ["presets\players\sfp_des.sqf", true];};
    case 30: {[] call compileScript ["presets\players\enoch.sqf", true];};
    default  {[] call compileScript ["presets\players\custom.sqf", true];};
};

switch (KPLIB_presetEnemy) do {
    case  1: {[] call compileScript ["presets\enemies\apex.sqf", true];};
    case  2: {[] call compileScript ["presets\enemies\rhs_afrf.sqf", true];};
    case  3: {[] call compileScript ["presets\enemies\takistan.sqf", true];};
    case  4: {[] call compileScript ["presets\enemies\islamic_state.sqf", true];};
    case  5: {[] call compileScript ["presets\enemies\sla.sqf", true];};
    case  6: {[] call compileScript ["presets\enemies\aaf.sqf", true];};
    case  7: {[] call compileScript ["presets\enemies\nato.sqf", true];};
    case  8: {[] call compileScript ["presets\enemies\gm_west.sqf", true];};
    case  9: {[] call compileScript ["presets\enemies\gm_west_win.sqf", true];};
    case 10: {[] call compileScript ["presets\enemies\gm_east.sqf", true];};
    case 11: {[] call compileScript ["presets\enemies\gm_east_win.sqf", true];};
    case 12: {[] call compileScript ["presets\enemies\unsung.sqf", true];};
    case 13: {[] call compileScript ["presets\enemies\cup_sla.sqf", true];};
    case 14: {[] call compileScript ["presets\enemies\cup_takistan.sqf", true];};
    case 15: {[] call compileScript ["presets\enemies\cup_chdkz.sqf", true];};
    case 16: {[] call compileScript ["presets\enemies\cup_afrf_msv.sqf", true];};
    case 17: {[] call compileScript ["presets\enemies\cup_afrf_msv_modern.sqf", true];};
    case 18: {[] call compileScript ["presets\enemies\cup_cdf.sqf", true];};
    case 19: {[] call compileScript ["presets\enemies\cup_baf_desert.sqf", true];};
    case 20: {[] call compileScript ["presets\enemies\cup_baf_woodland.sqf", true];};
    default  {[] call compileScript ["presets\enemies\custom.sqf", true];};
};

switch (KPLIB_presetResistance) do {
    case  1: {[] call compileScript ["presets\resistance\apex.sqf", true];};
    case  2: {[] call compileScript ["presets\resistance\rhs_gref.sqf", true];};
    case  3: {[] call compileScript ["presets\resistance\middle_eastern.sqf", true];};
    case  4: {[] call compileScript ["presets\resistance\racs.sqf", true];};
    case  5: {[] call compileScript ["presets\resistance\germany.sqf", true];};
    case  6: {[] call compileScript ["presets\resistance\unsung.sqf", true];};
    case  7: {[] call compileScript ["presets\resistance\cup_takistan.sqf", true];};
    case  8: {[] call compileScript ["presets\resistance\cup_napa.sqf", true];};
    default  {[] call compileScript ["presets\resistance\custom.sqf", true];};
};

switch (KPLIB_presetCivilians) do {
    case  1: {[] call compileScript ["presets\civilians\apex.sqf", true];};
    case  2: {[] call compileScript ["presets\civilians\middle_eastern.sqf", true];};
    case  3: {[] call compileScript ["presets\civilians\rds_civ.sqf", true];};
    case  4: {[] call compileScript ["presets\civilians\germany.sqf", true];};
    case  5: {[] call compileScript ["presets\civilians\unsung.sqf", true];};
    case  6: {[] call compileScript ["presets\civilians\cup_takistan.sqf", true];};
    case  7: {[] call compileScript ["presets\civilians\cup_cherno.sqf", true];};
    default  {[] call compileScript ["presets\civilians\custom.sqf", true];};
};
