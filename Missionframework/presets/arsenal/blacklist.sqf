/*
    KP Liberation custom blacklist preset
    ...
    Description:
    Blacklist file for the virtual arsenal.
    With this file you can create a custom blacklist for weapons etc.
...
// Weapons which shouldn't be available in the arsenal.
