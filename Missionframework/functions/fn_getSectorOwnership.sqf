/*
    ...
    Parameter(s):
        ...
        _radius - Radius to count units [NUMBER, defaults to KPLIB_capture_size]
...
params [
    ["_pos", [0, 0, 0], [[]], [2, 3]],
    ["_radius", KPLIB_capture_size, [0]]
];

private _capCount = 3;
private _capRatio = 0.85;
private _capRatioMin = 0.51;
private _blufor = [_pos, _radius, KPLIB_side_friendly] call KPLIB_fnc_getUnitsCount;
...
if (_blufor > 0 && {(_opfor <= _capCount && _ratio > _capRatioMin) || _ratio > _capRatio}) exitWith {KPLIB_side_friendly};
