private _objects_to_build = [
    ...
    [KPLIB_o_mrapArmed, [-17.72, 14.91, -0.00], 270.00],
    [KPLIB_o_transportTruck, [-16.45, 7.09, 0.00], 270.00]
];

private _objectives_to_build = [
    [KPLIB_o_fuelTruck, [14.36, -11.61, 0.00], 270.00],
    [KPLIB_o_fuelContainer, [-19.81, -11.27, 0.00], 270.00],
    [KPLIB_o_fuelContainer, [-19.85, -3.96, 0.00], 270.00]
];

private _defenders_to_build = [
    [KPLIB_o_engineer, [-13.45, 3.53, 0.00], 280.96],
    [KPLIB_o_heavyGunner, [17.42, 5.17, 3.13], 137.06],
    [KPLIB_o_medic, [17.92, 5.97, 0.60], 274.39],
    [KPLIB_o_officer, [12.32, 11.76, 0.60], 140.46],
    [KPLIB_o_sharpshooter, [-5.79, 11.84, 4.35], 297.99],
    [KPLIB_o_machinegunner, [-11.76, -18.72, 2.28], 152.95],
    [KPLIB_o_machinegunner, [-12.18, -3.17, 0.00], 204.36],
    [KPLIB_o_rifleman, [-13.48, -17.94, 2.28], 170.62],
    [KPLIB_o_rifleman, [-21.78, 17.73, 0.00], 176.87],
    [KPLIB_o_rifleman, [-5.56, -18.04, 0.00], 155.59],
    [KPLIB_o_rifleman, [10.34, 6.15, 0.60], 99.59],
    [KPLIB_o_rifleman, [19.16, 0.25, 0.00], 252.60],
    [KPLIB_o_rifleman, [4.08, 16.23, 0.00], 195.28],
    [KPLIB_o_rifleman, [8.68, -11.60, 0.00], 258.53],
    [KPLIB_o_riflemanLAT, [11.21, 13.16, 3.13], 309.16],
    [KPLIB_o_sentry, [-21.30, -7.60, 0.00], 97.63],
    [KPLIB_o_sentry, [-6.04, 4.12, 0.00], 80.41],
    [KPLIB_o_sentry, [2.14, -17.64, 2.28], 246.88],
    [KPLIB_o_marksman, [-3.27, 13.64, 4.35], 332.14],
    [KPLIB_o_marksman, [11.79, 5.74, 3.13], 224.23],
    [KPLIB_o_grenadier, [3.70, -19.06, 2.28], 179.85]
];
