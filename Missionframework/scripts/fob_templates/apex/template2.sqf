private _objects_to_build = [
    [KPLIB_o_flag, [-3.09, -13.03, 0.00], 0.00],
    ...
    [KPLIB_o_mrapArmed, [-15.71, -1.05, -0.00], 0.00]
];

private _objectives_to_build = [
    [KPLIB_o_ammoContainer, [-2.27, 6.72, 0.00], 270.00],
    [KPLIB_o_ammoContainer, [-2.50, 14.76, 0.00], 270.00],
    [KPLIB_o_fuelContainer, [-11.02, 13.18, 0.00], 0.00],
    [KPLIB_o_fuelContainer, [-15.81, 13.28, 0.00], 0.00]
];

private _defenders_to_build = [
    [KPLIB_o_engineer, [-13.04, 1.42, 0.00], 145.49],
    [KPLIB_o_medic, [12.00, -11.32, 0.72], 0.00],
    [KPLIB_o_machinegunner, [9.36, -9.69, 3.13], 224.39],
    [KPLIB_o_rifleman, [-15.90, 6.20, 0.00], 53.33],
    [KPLIB_o_rifleman, [-18.61, -12.86, 0.00], 256.70],
    [KPLIB_o_rifleman, [-2.21, 2.14, 0.00], 154.38],
    [KPLIB_o_rifleman, [-21.42, 5.74, 0.00], 0.00],
    [KPLIB_o_rifleman, [-21.63, 3.43, 2.78], 259.20],
    [KPLIB_o_rifleman, [-7.60, 14.78, 0.00], 177.51],
    [KPLIB_o_rifleman, [17.97, -2.54, 0.60], 222.59],
    [KPLIB_o_atSpecialist, [9.42, -3.19, 3.13], 299.23],
    [KPLIB_o_sentry, [-1.28, -12.69, 0.00], 0.00],
    [KPLIB_o_sentry, [21.72, 6.34, 0.00], 290.24],
    [KPLIB_o_marksman, [16.94, 14.54, 4.35], 333.07],
    [KPLIB_o_marksman, [19.91, 14.21, 4.35], 0.00],
    [KPLIB_o_teamLeader, [10.12, -4.12, 0.60], 175.70],
    [KPLIB_o_grenadier, [-21.11, 7.85, 2.78], 285.67],
    [KPLIB_o_grenadier, [9.27, 7.95, 0.00], 0.00]
];
