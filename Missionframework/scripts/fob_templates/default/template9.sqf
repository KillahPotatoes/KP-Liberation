...
private _defenders_to_build = [
    [KPLIB_o_engineer, [-10.53, -4.64, 0.00], 0.00],
    [KPLIB_o_heavyGunner, [-18.74, -15.05, 2.28], 270.00],
    [KPLIB_o_heavyGunner, [22.80, 18.84, 2.28], 0.00],
    [KPLIB_o_heavyGunner, [6.31, -14.37, 0.00], 318.61],
    [KPLIB_o_medic, [12.50, 1.07, 0.60], 244.47],
    [KPLIB_o_squadLeader, [7.16, -3.84, 0.60], 308.87],
    [KPLIB_o_atSpecialist, [5.57, 4.09, 3.13], 270.00],
    [KPLIB_o_rifleman, [-10.39, 6.70, 0.00], 181.51],
    [KPLIB_o_rifleman, [-18.42, -16.71, 2.28], 263.48],
    [KPLIB_o_rifleman, [-19.11, 5.66, 0.00], 251.10],
    [KPLIB_o_rifleman, [-19.58, 16.36, 2.28], 262.09],
    [KPLIB_o_rifleman, [-4.32, 24.55, 4.35], 0.00],
    [KPLIB_o_rifleman, [22.19, -15.53, 2.28], 155.63],
    [KPLIB_o_rifleman, [23.32, -13.89, 2.28], 84.56],
    [KPLIB_o_rifleman, [5.96, -3.84, 3.13], 265.58],
    [KPLIB_o_sentry, [-20.00, 17.92, 2.28], 0.00],
    [KPLIB_o_sentry, [10.18, 11.45, 0.00], 214.49],
    [KPLIB_o_marksman, [-2.31, 24.52, 4.35], 0.00],
    [KPLIB_o_grenadier, [-6.11, -14.77, 0.00], 0.00],
    [KPLIB_o_grenadier, [22.96, 17.33, 2.28], 82.66]
];
