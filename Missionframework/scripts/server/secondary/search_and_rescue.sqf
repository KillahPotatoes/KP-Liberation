...
{([(getpos _helowreck) getPos [30 + (random 30), random 360], _x, true] call KPLIB_fnc_spawnVehicle) addEventHandler ["Killed", {["KPLIB_manageKills", _this] call CBA_fnc_serverEvent;}]; } foreach _vehtospawn;
