...
if ( isNil "KP_factory_sectors_already_activated" ) then { KP_factory_sectors_already_activated = [] };

if ( !( _sector in KP_factory_sectors_already_activated )) then {

	KP_factory_sectors_already_activated pushback _sector;
