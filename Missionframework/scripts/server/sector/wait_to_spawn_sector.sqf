...
sleep 0.1;
private _unitscount = [markerPos _sector, _corrected_size , KPLIB_side_friendly] call KPLIB_fnc_getUnitsCount;
...
_unitscount = [markerPos _sector, _corrected_size, KPLIB_side_friendly] call KPLIB_fnc_getUnitsCount;
