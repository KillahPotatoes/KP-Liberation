...
// define array containing all currently used positions
if (isNil "KPLIB_usedPositions_SAM") then {KPLIB_usedPositions_SAM = []; publicVariable "KPLIB_usedPositions_SAM";};
// define array containing all turrets corresponding to a used position
		...
		while {_SAMdeleteTargetArray isNotEqualTo []} do {
			{
				...
				KPLIB_backCountryTurrets_SAM deleteAt _SAMdeleteTargetIndex;								// delete any destroyed or unmanned SAM turret from turret array
				KPLIB_usedPositions_SAM deleteAt _SAMdeleteTargetIndex;										// delete corresponding position from used positions array
