...
LARs_fnc_addWeapons = compileFinal preprocessFileLineNumbers "scripts\shared\functions\LARs_fnc_addWeapons.sqf";
LARs_fnc_addMagazines = compileFinal preprocessFileLineNumbers "scripts\shared\functions\LARs_fnc_addMagazines.sqf";
LARs_fnc_addItems = compileFinal preprocessFileLineNumbers "scripts\shared\functions\LARs_fnc_addItems.sqf";
LARs_fnc_addBackpacks = compileFinal preprocessFileLineNumbers "scripts\shared\functions\LARs_fnc_addBackpacks.sqf";
