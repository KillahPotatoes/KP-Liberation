...
[format ["Blufor: %1", KPLIB_presetPlayers], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Opfor: %1", KPLIB_presetEnemies], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Resistance: %1", KPLIB_presetResistance], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Civilians: %1", KPLIB_presetCivilians], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Arsenal: %1", KPLIB_presetArsenal], "MISSIONSTART"] call KPLIB_fnc_log;
