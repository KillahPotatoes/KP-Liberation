...
[format ["Blufor: %1", KPLIB_preset_blufor], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Opfor: %1", KPLIB_preset_opfor], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Resistance: %1", KPLIB_preset_resistance], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Civilians: %1", KPLIB_preset_civilians], "MISSIONSTART"] call KPLIB_fnc_log;
[format ["Arsenal: %1", KPLIB_arsenal], "MISSIONSTART"] call KPLIB_fnc_log;
