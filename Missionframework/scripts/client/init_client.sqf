...
switch (KP_liberation_arsenal) do {
    ...
    case  10: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\nato_mtp.sqf";};
    case  11: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\nato_tropic.sqf";};
    case  12: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\nato_wdl.sqf";};
    case  13: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\csat_hex.sqf";};
    case  14: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\csat_ghex.sqf";};
    case  15: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\aaf.sqf";};
    case  16: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\ldf.sqf";};
