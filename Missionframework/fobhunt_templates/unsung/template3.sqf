private _objects_to_build = [
    ...
    [KPLIB_o_flag, [-15.79, -3.95, 0.00], 0.00],
    [KPLIB_o_flag, [16.39, 1.56, 0.00], 0.00],
...
private _objectives_to_build = [
    [KPLIB_o_ammoContainer, [1.76, -8.89, 0.00], 270.00],
    [KPLIB_o_ammoContainer, [1.85, -13.44, 0.00], 270.00],
    [KPLIB_o_fuelContainer, [-6.11, -13.37, 0.00], 270.00],
    [KPLIB_o_fuelContainer, [-6.15, -8.81, 0.00], 270.00]
    ];

private _defenders_to_build = [
    [KPLIB_o_engineer, [14.44, 1.66, 0.00], 124.27],
    [KPLIB_o_heavyGunner, [3.22, 13.79, 0.00], 0.00],
    [KPLIB_o_medic, [2.37, 3.09, 0.00], 86.61],
    [KPLIB_o_officer, [0.73, 13.99, 0.00], 154.25],
    [KPLIB_o_rifleman, [-11.72, 19.08, 0.00], 308.60],
    [KPLIB_o_rifleman, [-14.81, -10.93, 0.00], 297.93],
    [KPLIB_o_rifleman, [-2.47, -11.92, 0.00], 0.00],
    [KPLIB_o_rifleman, [11.05, -16.87, 0.00], 103.44],
    [KPLIB_o_rifleman, [13.61, -6.92, 0.00], 70.80],
    [KPLIB_o_rifleman, [14.00, 11.59, 0.00], 107.80],
    [KPLIB_o_riflemanLAT, [9.81, -17.28, 0.00], 183.70],
    [KPLIB_o_sentry, [-11.14, 1.90, 0.00], 64.87],
    [KPLIB_o_sentry, [-2.53, 15.10, 0.00], 0.00],
    [KPLIB_o_sentry, [3.43, 0.56, 0.00], 0.00],
    [KPLIB_o_marksman, [-10.66, 19.57, 0.00], 0.00],
    [KPLIB_o_grenadier, [-10.48, 6.93, 0.00], 121.83],
    [KPLIB_o_grenadier, [14.28, 12.52, 0.00], 0.00]
];
