...
private _defenders_to_build = [
    [KPLIB_o_engineer, [12.94, -4.11, 0.00], 93.06],
    [KPLIB_o_heavyGunner, [-13.52, -13.88, 4.88], 186.59],
    [KPLIB_o_medic, [8.98, 11.77, 0.00], 210.35],
    [KPLIB_o_rifleman, [-13.37, 0.92, 0.00], 271.85],
    [KPLIB_o_rifleman, [-13.78, 13.34, 4.87], 235.25],
    [KPLIB_o_rifleman, [-4.09, 0.81, 0.00], 114.75],
    [KPLIB_o_rifleman, [-6.94, 13.46, 0.00], 0.00],
    [KPLIB_o_rifleman, [14.09, 13.37, 4.83], 98.03],
    [KPLIB_o_atSpecialist, [6.97, 0.37, 0.00], 285.40],
    [KPLIB_o_sentry, [-14.61, -12.85, 4.83], 239.93],
    [KPLIB_o_sentry, [-4.64, -1.39, 0.00], 147.93],
    [KPLIB_o_sentry, [12.63, -13.31, 4.83], 197.32],
    [KPLIB_o_marksman, [-13.29, 14.03, 4.85], 323.41],
    [KPLIB_o_marksman, [12.96, 14.41, 4.87], 0.00],
    [KPLIB_o_marksman, [13.41, -12.52, 4.86], 126.65],
    [KPLIB_o_squadLeader, [9.30, 8.28, 0.00], 250.30],
    [KPLIB_o_grenadier, [1.15, -12.96, 0.00], 206.96]
];
