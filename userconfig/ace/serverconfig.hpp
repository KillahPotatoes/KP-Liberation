...
class ace_medical_useLocation_basicEpi {
    value = 0; // 0 = Überall, 1 = Fahrzeuge, 2 = Einrichtungen, 3 = Fahrzeuge & Einrichtungen
    typeName = "SCALAR";
    force = 1;
};
class ace_medical_useLocation_PAK {
    value = 2; // 0 = Überall, 1 = Fahrzeuge, 2 = Einrichtungen, 3 = Fahrzeuge & Einrichtungen
    typeName = "SCALAR";
    force = 1;
};
class ace_medical_useLocation_SurgicalKit {
    value = 3; // 0 = Überall, 1 = Fahrzeuge, 2 = Einrichtungen, 3 = Fahrzeuge & Einrichtungen
    typeName = "SCALAR";
    force = 1;
};
class ace_medical_useCondition_PAK {
    value = 1; // 0 = Immer, 1 = Stabil (alles blau oder weiß)
    typeName = "SCALAR";
    force = 1;
};
...
class ace_mk6mortar_airResistanceEnabled {
    value = 0; // 0 = Deaktiviert, 1 = Aktiviert
    typeName = "BOOL";
    force = 1;
};
...
class ace_mk6mortar_allowCompass {
    value = 1; // 0 = Deaktiviert, 1 = Aktiviert
    typeName = "BOOL";
    force = 1;
};
