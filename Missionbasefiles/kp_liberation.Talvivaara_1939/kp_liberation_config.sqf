...
GRLIB_sector_size = 750;                                               // Range to activate a sector.
...
GRLIB_surrender_chance = 20;                                            // Chance that enemy infantry will surrender after heavy losses are encountered.

GRLIB_civilians_amount = 10;                                            // Civilian count multiplier.
GRLIB_cleanup_delay = 900;                                             // Time in seconds until bodies of dead soldiers are cleaned up.
...
KP_liberation_cr_wounded_chance = 5;                                    // Chance (0-100) that there are wounded civilians right after capturing a sector.
KP_liberation_cr_wounded_gain = 14;                                      // Civil Reputation gain for providing medical assistance for wounded civilians.
